...
export default function Loader() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4 text-center">
      ...
      {loaderViewState ? (
        <>
          <div className="mb-2 text-lg font-semibold opacity-85">
          ...
          <div
            className={`flex min-h-[3.5rem] max-w-xl items-center justify-center text-center text-base italic transition-all duration-500 ${
              animate ? 'scale-100 opacity-50' : 'scale-95 opacity-0'
            }`}
          >
