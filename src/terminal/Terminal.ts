...
import { getIconPathObject } from '../utilities/contextManager';
...
export class Terminal extends BaseTerminal {
  ...
  constructor(id: number, terminal: vscode.Terminal | undefined, cwd: string) {
    ...
    const iconPath = getIconPathObject();

    this.terminal = terminal ?? vscode.window.createTerminal({ cwd, name: 'DeputyDev', iconPath, env });
