...
import type { DDTerminalProcess, DDTerminalProcessEvents, ExitCodeDetails } from './types';

export abstract class BaseTerminalProcess extends EventEmitter<DDTerminalProcessEvents> implements DDTerminalProcess {
