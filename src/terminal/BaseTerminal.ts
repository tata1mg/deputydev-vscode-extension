...
import type {
  ...
  DDTerminalCallbacks,
  DDTerminalProcess,
  DDTerminalProcessResultPromise,
  ExitCodeDetails,
} from './types';

export abstract class BaseTerminal implements DDTerminal {
  public readonly provider: DDTerminalProvider;
  ...
  public process?: DDTerminalProcess;
  public completedProcesses: DDTerminalProcess[] = [];

  constructor(provider: DDTerminalProvider, id: number, cwd: string) {
  ...
  abstract runCommand(command: string, callbacks: DDTerminalCallbacks): DDTerminalProcessResultPromise;
   ...
   */
  public getProcessesWithOutput(): DDTerminalProcess[] {
