export const API_ENDPOINTS = {
  ...
  READ_FILE_SUMMARY: '/v1/read-file-summary',
  ...
  CODE_REVIEW_PRE_PROCESS: '/end_user/v1/extension-code-review/pre-process',
  ...
  USER_AGENTS: '/end_user/v1/extension-code-review/user-agents',
};
