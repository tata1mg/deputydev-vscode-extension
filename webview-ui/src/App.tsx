...
function App() {
  ...
  const showForceUpgrade = useForceUpgradeStore(
    (state) => state.showForceUpgrade,
  );
  const setShowForceUpgrade = useForceUpgradeStore(
    (state) => state.setShowForceUpgrade,
  );
