...
function ChatTypeToggle(props: ChatTypeToggleProps) {
  ...
  return (
    ...
    <div
      className={`relative flex w-[95px] ${activeHeightClass} items-center overflow-hidden rounded-xl`}
    >
      {/* Inactive Background Element: Smaller height, centered vertically */}
      <div
        className={`absolute ${inactiveVerticalInset} left-0 right-0 ${inactiveBg} rounded-lg ${borderClass} `}
        aria-hidden="true"
      />
