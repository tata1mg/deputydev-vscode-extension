...
export default function Setting() {
  ...
  <div className="flex flex-col">
    <span className="opacity-70 font-medium">Enable Terminal Auto-Execution</span>
          ...
          <div className="mt-2 flex w-full flex-col gap-2 rounded border border-gray-500/10 bg-gray-500/20 p-2 text-sm">
            ...
            {!showInput && (
              <button
                ...
                className="mt-1 flex items-center gap-2 self-start rounded border border-gray-400 px-3 py-1 text-sm hover:bg-gray-100 transition"
              >
            ...
            {showInput && (
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded border border-gray-400 px-3 py-1 text-sm hover:bg-gray-100 transition"
                >
                  Add
                </button>
              </div>
